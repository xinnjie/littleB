/*
 * xinnjie: copy from wangle, for debug purpose
 ...
 */
class LengthFieldBasedFrameDecoder : public wangle::ByteToByteDecoder {
public:
    explicit LengthFieldBasedFrameDecoder(uint32_t lengthFieldLength = 4, uint32_t maxFrameLength = UINT_MAX,
                                          uint32_t lengthFieldOffset = 0, int32_t lengthAdjustment = 0,
                                          uint32_t initialBytesToStrip = 4, bool networkByteOrder = true);
